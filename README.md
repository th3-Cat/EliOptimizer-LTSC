...
* **Interfaz Gráfica (UI):** Este proyecto utiliza la arquitectura visual y el motor de renderizado de componentes basado en **EdgeControl**, desarrollado originalmente por **Daniel Rodríguez** @xdoofy92 bajo la licencia MIT. Agradezco enormemente su contribución al software libre, la cual hizo posible la base interactiva de esta herramienta.
