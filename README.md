...
2. Haz clic derecho sobre el archivo en tu computadora y selecciona **Ejecutar con PowerShell**.
...
Este proyecto es **100% de código abierto**. El archivo `.ps1` es de texto puro y no contiene dependencias externas ni instaladores opacos. Puedes auditarlo, modificarlo o usarlo libremente en tus labores de soporte técnico técnico o mantenimiento informático diario.
